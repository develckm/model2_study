...
public interface MemberDaoAble {
	...
	public MemberVo detail(String id) throws ClassNotFoundException, SQLException ; //관리자 수정, 개인 정보 수정페이지, 개인 정보 상세페이지,회원가입 ajax,관리자 회원등록 ajax  
	public MemberVo login(String id,String pw) throws ClassNotFoundException, SQLException;//로그인  
